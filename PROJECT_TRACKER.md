...
| | |
|---|---|
| **Phase** | **4 Demo UI + product surfaces** — employee/governance portals live; `/glassbox` canvas for judges |
...
| W06 | Phase 4 — Demo UI | **Agent** | 🟢 Done | Employee + governance portals; glassbox canvas; Playwright e2e |
| W08 | HITL + negotiation transparency | **Shirley** | 🟢 Demo-ready | Gateway activity UX; policy-by-hash; glassbox canvas — [`docs/DEMO_SCRIPT.md`](docs/DEMO_SCRIPT.md) v2 |
