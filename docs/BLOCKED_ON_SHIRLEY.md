...
| **B09** | ~~Invite teammate to GitHub~~ | ✅ Done — mutual collaborator on private repos (2026-07-05) |
...
| Canonical repo = `shirley-xue-2025/trust-flow` | Max fork is stale snapshot only     |
| Deploy split: Shirley codes, Max redeploys ECS | See `DEPLOY_AND_REPO_COORDINATION.md` |
| B09 collaborator invite                     | Done 2026-07-05                         |
...
- Boardroom protocol + MVP scope
- Roleplay scenario 001
- Stakeholder journey map (R5)
- Fake-door copy draft
- `DECISION_LOG.md` with recommended defaults
- Seed fixtures (`tool_registry`, `org_config`)
- Eval scenarios S01–S05 as JSON fixtures
- Update SESSION_LATEST + RESEARCH_LEDGER
